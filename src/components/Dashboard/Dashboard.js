...
export default function Dashboard({ data, disabled, actionError, setCarriedBalance, setRewardGoal, spendReward, undoSpend, addQuest, removeQuest, toggleComplete, reorderQuests, updateQuestReward }) {
